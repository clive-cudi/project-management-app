            ...
            <div className={styles.prb_nav_wrapper}>
                <div className={styles.prb_nav}>
                    ...
                    <div className={styles.prb_nav_col}>
                        ...
                        <RegularBtn label={"Add Task"} withIcon={{status: true, icon: <BsPlus />, orientation: "start"}} variant={"outlined"} data-elm-type={"btn-add"} onClick={(e) => {openCreateProjectModalForm()}} />
                        <IconBtn icon={<BsThreeDotsVertical />} variant={"outlined"} onClick={() => {}} />
                    </div>
                </div>
            </div>
            <div className={styles.prb_boards_wrapper}>
                <ProjectsSummaryBoard title={"To Do"} info={"1 Task"} boardData={[{
                ...
                <ProjectsSummaryBoard title={"In Progress"} boardData={[]} />
                <ProjectsSummaryBoard title={"Done"} info={"1 Task"} boardData={[{
