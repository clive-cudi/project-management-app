            ...
            <div className={styles.st_content_view_wrapper}>
                ...
                <div className={styles.ct_integrations_wrapper}>
                    {integrations.map((integration) => {
                        return (
                            <div className={styles.ct_int_widget}>
